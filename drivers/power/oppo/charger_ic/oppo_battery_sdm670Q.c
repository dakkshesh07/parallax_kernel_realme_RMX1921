...
#ifdef CONFIG_REALME_RETARD//OuYangBaiLi@BSP.CHG.Basic 2019/03/05 modify for factory otg
...
#ifdef CONFIG_REALME_RETARD//Fanhong.Kong@ProDrv.CHG,add 2018/06/02 for SVOOC OTG
		if(chip->vbatt_num == 2)
		{
...
#ifdef CONFIG_REALME_RETARD//Fanhong.Kong@ProDrv.CHG,add 2018/04/20 for SVOOC
